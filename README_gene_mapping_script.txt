...
This R script takes a list of (mouse) gene names and attempts to identify known synonyms and human orthologues. This can be useful when working with data that might have outdated or alternate gene symbols.
